    ...
    <div class="chart-container card">
      ...
      <div v-if="positiveAccounts.length" class="bar-chart">
        ...
        <div v-for="account in positiveAccounts" :key="`p-${account.id}`" class="bar-row">
          ...
          <div class="bar-outer">
            <div class="bar-fill" :class="account.adjusted_balance >= 0 ? 'asset-bar' : 'liability-bar'"
        ...
        <div class="axis">
          <div class="axis-line" />
          <span v-for="(tick, idx) in ticks" :key="idx" class="axis-tick"
      ...
      <div class="bar-axis" v-if="allVisibleAccounts.length">
        <span v-for="n in 5" :key="n" class="tick" :style="{ left: `${((n - 1) / 4) * 100}%` }">
