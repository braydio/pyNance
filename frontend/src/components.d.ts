...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    CategoryTransactionsModal: typeof import('./components/modals/CategoryTransactionsModal.vue')['default']
    ...
    DailyNetTransactionsModal: typeof import('./components/modals/DailyNetTransactionsModal.vue')['default']
