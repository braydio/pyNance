  ...
  <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-3xl mx-2 relative">
      <div class="flex items-center justify-between px-6 py-4 border-b">
        ...
        <button class="p-1 rounded hover:bg-gray-100 transition absolute right-3 top-3" @click="emitClose"
          aria-label="Close">
      ...
      <div class="px-6 py-3 flex justify-end border-t">
        <button class="px-4 py-2 rounded bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold"
