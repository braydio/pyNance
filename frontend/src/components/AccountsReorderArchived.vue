...
.accounts-reorder-chart {
  padding: 1rem;
  background-color: var(--color-bg-dark); /* #282828 */
  color: var(--color-text-light); /* #ebdbb2 */
  border-radius: 8px;
  margin: 1rem;
}
.chart-summary {
...
.group h3 {
  ...
  color: var(--color-accent-yellow); /* #fabd2f */
  font-family: "Fira Code", monospace;
}
.account-bar {
  margin-bottom: 0.5rem;
  padding: 0.5rem;
  background-color: var(--color-bg-secondary); /* #3c3836 */
  border-radius: 4px;
  cursor: move;
  display: flex;
