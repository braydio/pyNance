<template>
  <div class="container py-8 space-y-8">
    ...
    <section class="card">
      ...
      <button @click="toggleAccordion" class="btn mb-4">Toggle Accordion</button>
    ...
    <!-- List Animations -->
    <section class="card">
      <h2 class="text-xl font-bold mb-4 text-[var(--color-accent-cyan)]">
    ...
    <section class="card">
      ...
      <button @click="showModal = true" class="btn hover-lift">Show Modal</button>
    </section>
    ...
    <transition name="modal-fade-slide">
      ...
      >
        <div
          class="relative w-full max-w-md mx-auto rounded-2xl shadow-2xl bg-gradient-to-br from-violet-950/70 via-slate-900/90 to-blue-950/90 border-2 border-violet-400/40 p-6"
        >
          <button
          ...
          >
            <svg
              class="w-6 h-6 text-violet-200 group-hover:text-white transition"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="2"
          ...
          <p class="text-gray-300">
            This modal uses the same fadeInUp animation as the TransactionModal.
          </p>
        </div>
      </div>
    </transition>
