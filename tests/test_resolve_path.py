...
paths_module = os.path.join(os.path.dirname(__file__), "..", "backend", "app", "config", "paths.py")
...
MODULE_PATH = os.path.join(os.path.dirname(__file__), "..", "backend", "app", "helpers", "path_utils.py")
