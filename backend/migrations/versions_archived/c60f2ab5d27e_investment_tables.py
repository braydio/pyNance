...
def upgrade():
    ...
    with op.batch_alter_table('investment_holdings', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_investment_holdings_account_id'), ['account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_investment_holdings_security_id'), ['security_id'], unique=False)
    ...
    with op.batch_alter_table('investment_transactions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_investment_transactions_account_id'), ['account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_investment_transactions_security_id'), ['security_id'], unique=False)
