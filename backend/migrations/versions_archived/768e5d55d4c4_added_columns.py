...
def upgrade():
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        ...
        if has_institutions and "fk_accounts_institution_db_id_institutions" not in account_fks:
    ...
    if not is_sqlite:
        ...
        with op.batch_alter_table("plaid_accounts", schema=None) as batch_op:
            ...
            batch_op.add_column(sa.Column("institution_db_id", sa.Integer(), nullable=True))
            if has_institutions and ("fk_plaid_accounts_institution_db_id_institutions" not in plaid_fks):
                batch_op.create_foreign_key(
    ...
    recurring_columns = {col["name"] for col in insp.get_columns("recurring_transactions")}
    recurring_fks = {fk["name"] for fk in insp.get_foreign_keys("recurring_transactions")}
    if not is_sqlite:
    ...
    if not is_sqlite:
        ...
        with op.batch_alter_table("teller_accounts", schema=None) as batch_op:
            ...
            batch_op.add_column(sa.Column("institution_db_id", sa.Integer(), nullable=True))
            if has_institutions and ("fk_teller_accounts_institution_db_id_institutions" not in teller_fks):
                batch_op.create_foreign_key(
...
def downgrade():
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f("fk_accounts_institution_db_id_institutions"), type_="foreignkey")
