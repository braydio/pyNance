...
def upgrade():
    ...
    op.create_table('account_group_preferences',
    ...
    with op.batch_alter_table('account_group_preferences', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_account_group_preferences_active_group_id'), ['active_group_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_account_group_preferences_user_id'), ['user_id'], unique=True)

    op.create_table('account_group_memberships',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('account_group_memberships', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_account_group_memberships_account_id'), ['account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_account_group_memberships_group_id'), ['group_id'], unique=False)
