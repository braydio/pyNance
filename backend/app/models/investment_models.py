...
class Security(db.Model, TimestampMixin):
    ...
    institution_price = db.Column(db.Numeric(18, 2), nullable=True)
...
class InvestmentHolding(db.Model, TimestampMixin):
    ...
    cost_basis = db.Column(db.Numeric(18, 2), nullable=True)
    institution_value = db.Column(db.Numeric(18, 2), nullable=True)
...
class InvestmentTransaction(db.Model, TimestampMixin):
    ...
    type = db.Column(db.String(64), nullable=True)
    name = db.Column(db.String(256), nullable=True)
    fees = db.Column(db.Numeric(18, 2), nullable=True)
    iso_currency_code = db.Column(db.String(8), nullable=True)
