...
def get_forecast():
    ...
    try:
        ...
        manual_income = float(request.args.get("manual_income", 0) or 0)
        liability_rate = float(request.args.get("liability_rate", 0) or 0)
        user_id = request.args.get("user_id")

        orchestrator = forecast_orchestrator.ForecastOrchestrator(db)
