...
def main():
    parser = argparse.ArgumentParser(
        description="Generate CSS or JSON from an HTML file."
    )
    parser.add_argument("html_file", help="Path to the input HTML file.")
    parser.add_argument(
        "--css", help="Generate a CSS file (provide the output path).", default=None
    )
    parser.add_argument(
        "--json",
        help="Generate a JSON structure file (provide the output path).",
        default=None,
    )
